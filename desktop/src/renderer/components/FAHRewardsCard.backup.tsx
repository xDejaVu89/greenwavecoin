  ...
  const handleClaim = async () => {
    ...
    try {
      ...
      for (const claim of claims) {
        ...
        // TODO: Backend needs to generate proper Merkle proof
        // For now, this will fail until proof generation is implemented
        const proof: string[] = []; // Placeholder
        
        // Submit claim transaction
        const tx = await claimRewards(
          signer,
          network.chainId,
          0, // index - will need proper indexing later
          address,
          claim.claimableReward.replace(' GWC', ''),
          proof
        );
