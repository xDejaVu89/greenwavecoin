 ...
 */
export function validateSubmitResult(req: Request, res: Response, next: NextFunction) {
 ...
 */
export function validateWalletParam(req: Request, res: Response, next: NextFunction) {
